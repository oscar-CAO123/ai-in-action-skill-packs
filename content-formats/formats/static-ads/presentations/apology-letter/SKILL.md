...
cites: local:optamize-8-statics/03-apology-letter
...
`local:optamize-8-statics/03-apology-letter`: **the frame swap and the copy structure, beat for
beat.** the operator, 2026-08-10: "model the copy structure and the way copy is presented within the
Gruns reference."
...
a result, and a result is exactly what `../../proof/` bans. the operator's replacement is the job said in
...
the operator's instruction, 2026-08-10. It is derived from the industry's own `short`, so all seven read
