...
THEMES = {
    ...
    # Same as `noir` in every respect except case. the operator, 2026-08-06, for the ripped news
...
# Default stays "dark", so every existing card renders byte-identical. the operator, 2026-08-07.
GROUNDS = {
...
.accent {{ {t["accent"]} }}
/* The divider rule (the operator, 2026-08-10, canonical on the inverted ends of a Theme B carousel).
   ...
   full-bleed version was tried first and rejected on 2026-08-10.
...
def render_card(lines, png, assets=None, chrome=None, plate=None, overlay=None,
    ...
    if plate:
        ...
        if plate_full:
            # The plate bleeds the whole frame. Added 2026-08-06 for the ripped news collage.
